            ...
            <Link to={`/posts/${post._id}`} className="post-link">
              <div className="post-card">
                      <div className="post-name-age">
                        ...
                        <p className="post-age">גיל: {post.age}</p>
                      </div>
                ...
                <Card className="post-card-image">
                  ...
                  <div className="button-container">
                    {canEditOrDelete(post.author) && (
                      <>
                        <Button variant="danger" onClick={() => deletePost(post._id)}>מחק</Button>
                        <Link to={`/edit/${post._id}`} className="btn btn-primary">ערוך</Link>
                        {!post.isAdopted && <Button variant="success" onClick={() => handleAdoptButton(post._id)}>אמץ</Button>}
                      </>
                    )}
                  </div>
                </Card>
